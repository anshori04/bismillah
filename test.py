...
def main():
    st.title("Aplikasi Streamlit dengan Pembaruan Setiap 1 Menit")

    # Loop utama
    while True:
        # Tampilkan konten Streamlit di sini
        st.write("Konten yang diperbarui setiap 1 menit")

        # Tunggu selama 1 menit sebelum memperbarui kembali
        time.sleep(60)
